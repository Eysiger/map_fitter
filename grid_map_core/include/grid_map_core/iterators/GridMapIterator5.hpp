...
public:
   ...
   */
  GridMapIterator5(const grid_map::GridMap &gridMap, const int every);

  /*!
   * Copy constructor.
   * @param other the object to copy.
   */
  GridMapIterator5(const GridMapIterator5* other);
   ...
   */
  GridMapIterator5& operator =(const GridMapIterator5& other);

  /*!
   * Compare to another iterator.
   * @return whether the current iterator points to a different address than the other one.
   */
  bool operator !=(const GridMapIterator5& other) const;
   ...
   * Example: See `runGridMapIterator5Version2()` of `grid_map_demos/src/iterator_benchmark.cpp`.
